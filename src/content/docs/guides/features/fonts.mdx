...
随后，在导航栏中选“博客配置”->“字体配置”，即可修改自带的字体

HyC 支持从本地 TTF 文件和中文网字计划源获取文件并进行替换

### 本地源

本地源上传 TTF 文件即可，**不支持其他格式，请自行转换**

### 中文网字计划源

点击控制台中的[中文网字计划 CDN 页面](https://chinese-font.netlify.app/zh-cn/cdn/)，进入网站，选择自己喜欢的字体，这里以“思源屏显臻宋”为例：
![中文网字计划 CDN 页面](./fonts/chinese-font-page.png)
复制红框中的文字，此处为“sypxzs”，随后进入控制台，选择中文网字计划源，选择替换目标，输入名称，点击查询 TTF 列表：
![控制台页面](./fonts/console.png)

如果存在多个 TTF 文件变体则需要选择，一般选择 Regular 即可

随后点击替换，待提示完成后可重新构建网站来应用新字体
